...
* Wechseln Sie in das Programmverzeichnis, in dem Sie KIS installiert haben (zum Beispiel "c:\Program files (x86)\Kaspersky lab\Kaspersky Internet Security 17.0.0")
